...
public class TrueTypeFont {
  ...
  public byte[] writeFont() {
    ...
    // write the tables
    for( String tagString : tables.keySet() ) {
  ...
  public String toString() {
    ...
    sb.append( "NumTables    : " ).append( getNumTables() ).append( "\n" );
    sb.append( "SearchRange  : " ).append( getSearchRange() ).append( "\n" );
    sb.append( "EntrySelector: " ).append( getEntrySelector() ).append( "\n" );
    sb.append( "RangeShift   : " ).append( getRangeShift() ).append( "\n" );

    for( final var stringObjectEntry : tables.entrySet() ) {
      TrueTypeTable table;

      if( stringObjectEntry.getValue() instanceof ByteBuffer ) {
        table = getTable( stringObjectEntry.getKey() );
      }
      else {
        table = (TrueTypeTable) stringObjectEntry.getValue();
      }

...
public class Type1CFont extends OutlineFont {
  ...
  private void readDict( Range r ) {
    //	System.out.println("reading dictionary from "+r.getStart()+" to "+r
      //	.getEnd());
    pos = r.getStart();
    while( pos < r.getEnd() ) {
  ...
  private void readNames( int base ) {
    ...
    for( int i = 0; i < nextra; i++ ) {
      ...
      //	    System.out.println("Read name: "+i+" from "+r.getStart()+"
      //	    to "+r.getEnd()+": "+safe(names[i]));
    }
  }

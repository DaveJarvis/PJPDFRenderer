...
public abstract class PDFShader {
   ...
   */
  public static PDFShader getShader( PDFObject shaderObj, Map<String, PDFObject> resources )
    throws IOException {
    ...
    shader = switch( type ) {
      ...
      default -> throw new PDFParseException( "Unsupported shader type: " + type );
    };

...
/**
 * A ColorSpace for the YCCK color space.  This color space converts to CMYK
 * and then
 * uses an existing CMYK color space to convert from CMYK to RGB.  This
 * allows embedded
...
public class YCCKColorSpace extends ColorSpace {
  ...
  private float[] toCmyk( float[] colorvalue ) {
    float y = colorvalue[ 0 ], cb = colorvalue[ 1 ], cr = colorvalue[ 2 ], k
      = colorvalue[ 3 ];

...
public class CMapFormat4 extends CMap {
  ...
  public String toString() {
    ...
    buf.append( indent )
       .append( "SegmentCount : " )
       .append( getSegmentCount() )
       .append( "\n" );
    buf.append( indent )
       .append( "SearchRange  : " )
       .append( getSearchRange() )
       .append( "\n" );
    buf.append( indent )
       .append( "EntrySelector: " )
       .append( getEntrySelector() )
       .append( "\n" );
    buf.append( indent )
       .append( "RangeShift   : " )
       .append( getRangeShift() )
       .append( "\n" );

    for( Segment s : segments.keySet() ) {
      buf.append( indent );
      buf.append( "Segment: " )
         .append( Integer.toHexString( s.startCode ) );
      buf.append( "-" )
         .append( Integer.toHexString( s.endCode ) )
         .append( " " );
      buf.append( "hasMap: " ).append( s.hasMap ).append( " " );

      if( !s.hasMap ) {
        buf.append( "delta: " ).append( segments.get( s ) );
      }
  ...
  static class Segment implements Comparable<Object> {
    /**
    ...
    public int compareTo( Object o ) {
      ...
      return Integer.compare( endCode, s.endCode );
    }
  }
}

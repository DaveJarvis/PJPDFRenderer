...
public class Cache {
   ...
   */
  private final Map<Integer, SoftReference<?>> pages;
  ...
  PageRecord getPageRecord( Integer pageNumber ) {
    final var ref = pages.get( pageNumber );
   ...
   */
  void removePageRecord( Integer pageNumber ) {
   ...
   */
  void addImageRecord( PDFPage page, ImageInfo info,
